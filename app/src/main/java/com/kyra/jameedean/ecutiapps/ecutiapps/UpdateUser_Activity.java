...
public class UpdateUser_Activity extends AppCompatActivity implements AdapterView.OnItemSelectedListener{
    ...
    private void actionNotification(DatabaseError error, int successResourceId) {
        // close activity
        if(error == null) {
            Toast.makeText(UpdateUser_Activity.this, successResourceId, Toast.LENGTH_SHORT).show();
            finish();
        } else {
            Toast.makeText(UpdateUser_Activity.this, error.getCode(), Toast.LENGTH_SHORT).show();
        }
    }
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (task.isSuccessful()) {
                            sendEmailVerification();
                            Toast.makeText(UpdateUser_Activity.this, "Registration successful. Verification Email Send.", Toast.LENGTH_LONG).show();
                            ...
                            FirebaseDatabase.getInstance().getReference("Users").child(Reference.USER_INFO)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    if (task.isSuccessful()) {
                                        Toast.makeText(UpdateUser_Activity.this, getString(R.string.registration_success), Toast.LENGTH_LONG).show();
                                        startActivity(new Intent(UpdateUser_Activity.this, StaffMain_Activity.class));
                                    } else {
                                        //display a failure message
                                        progressDialog.dismiss();
                                        Toast.makeText(UpdateUser_Activity.this, getString(R.string.registration_failed), Toast.LENGTH_LONG).show();
                                    }
                                }
                            });

                        } else {
                            Toast.makeText(UpdateUser_Activity.this, task.getException().getMessage(), Toast.LENGTH_LONG).show();
                            progressDialog.dismiss();
                        }
                    }
                });
        ...
        user.sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()) {
                    ...
                    Toast.makeText(UpdateUser_Activity.this,"Check email to verify.",Toast.LENGTH_LONG).show();
